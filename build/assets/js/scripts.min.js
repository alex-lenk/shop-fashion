...
;// CONCATENATED MODULE: ./src/js/components/_accordion-collapse.js
/* BEGIN: Аккордеон */
function _accordionCollapse(selector, selectorActive) {
  let menuList = document.getElementsByClassName(selector),
      i = 0;
...
/* END */
;// CONCATENATED MODULE: ./src/js/components/_dropdown.js
/* BEGIN: Аккордеон */
